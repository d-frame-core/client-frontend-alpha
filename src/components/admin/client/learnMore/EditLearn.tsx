...
const EditClientLearn: React.FC<EditDialogProps> = ({ open, onClose, oneData }) => {
  ...
  const onSubmit = async (data:any) => {
    try {
      ...
      const response = await axios.put(`http://localhost:8000/LearnMore/admin/update/${oneData?._id}`, data);
...
export default EditClientLearn;
