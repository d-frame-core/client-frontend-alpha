      ...
      <Header/>
        ...
        <Box className='side'>
          ...
          <NavLink to='/profile' style={{textDecoration:'none'}} onClick={()=> index=1} >
            ...
            <NavLink to='/datapool' style={{textDecoration:'none',color:'white',width:'18vw'}}onClick={()=> index=2}>
            <div className={toggleState === 3? "act1" : "notActive"}>
                <CalendarTodayIcon className="ic"/>Data Pool
            </div>
            </NavLink>
            <NavLink to='/campaigns' style={{textDecoration:'none',color:'white',width:'18vw'}}onClick={()=> index=2}>
            <div className={toggleState === 4? "act1" : "notActive"}>
                <SearchIcon className="ic"/>Campaigns
            </div>
            </NavLink>
            <NavLink to='/ads' style={{textDecoration:'none',color:'white',width:'18vw'}}onClick={()=> index=2}>
            <div className={toggleState === 5? "act1" : "notActive"}>
                <InsertChartOutlinedOutlinedIcon className="ic"/>Ads History
            </div>
            </NavLink>
            <NavLink to='/settings' style={{textDecoration:'none',color:'white',width:'18vw'}}onClick={()=> index=2}>
            <div className={toggleState === 6? "act1" : "notActive"}>
                <SettingsOutlinedIcon className="ic"/>Settings
            </div>
            </NavLink>
            </div>
